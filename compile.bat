...
windres %TargetDirectory%\resource_file.rc %TargetDirectory%\resource_file.o
echo .rc file converted succesfully
echo Compiling code...
gcc %TargetDirectory%\resource_file.o -g %TargetDirectory%\%TargetFile% -o %OutputDirectory%\%OutputName%.%FileExtension% -lglfw3 -lopengl32 -lgdi32 -mwindows -std=c11
echo Code compiled
pause
goto Options
...
echo                         -              -------        ------           -------                     
echo ===========================================================================================================                                                                                                    
echo                                   This compiler has been made by Beta Studio.
pause
goto Options
